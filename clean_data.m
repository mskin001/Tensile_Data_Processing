...
str_markers = [4239, 6176, 4367, 6080;
                ...
                2.6325e4, 2.815e4, 2.643e4, 2.808e4]; %GF12-01
...
% get index locations for key points
    ...
    exp_time{b} = time(str_markers(b,1):str_markers(b,2)) - time(str_markers(b,1));
